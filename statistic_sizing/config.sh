...
MATRICS_OUTPUT_FOLDER_1080P='/isaac-sim/replicator_data/statistic_sizing/metrics/1080p'

# 2k resolution
RESOLUTION_2K="2560 1440"
OUTPUT_DIR_2K="$ISAAC_SIM_PATH$OUTPUT_BASE_DIR/2k"
MATRICS_OUTPUT_FOLDER_2K='/isaac-sim/replicator_data/statistic_sizing/metrics/2k'


# 4k resolution
RESOLUTION_4K="3840 2160"
OUTPUT_DIR_4K="$ISAAC_SIM_PATH$OUTPUT_BASE_DIR/4k"
MATRICS_OUTPUT_FOLDER_4K='/isaac-sim/replicator_data/statistic_sizing/metrics/4k'
